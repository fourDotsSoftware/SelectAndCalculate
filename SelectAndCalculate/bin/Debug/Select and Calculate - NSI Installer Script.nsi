...
;copy translations end
  ...
  !define MUI_FILE "SelectAndCalculate"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Select and Calculate"
  !define PRODUCT_SHORTCUT "Select and Calculate"
  !define PRODUCT_VERSION "1.0"
  
  !define MUI_ICON "select-and-calculate.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Select and Calculate"
  OutFile "SelectAndCalculateSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Select and Calculate" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Select and Calculate - User's Manual.url.lnk" "$INSTDIR\Select and Calculate - User's Manual.url" "" "$INSTDIR\Select and Calculate - User's Manual.url" 0
...
!endif
  ...
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\SelectAndCalculateShellExtx64.dll $SYSDIR\SelectAndCalculateShellExt.dll $SYSDIR
  SetRegView 64
...
;   ExecWait '"$INSTDIR\vcredist_x86.exe" /q'
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\SelectAndCalculateShellExt_vs2008_w7_x86.dll $SYSDIR\SelectAndCalculateShellExt.dll $SYSDIR
...
;!  inetc::get /SILENT "http://www.4dots-software.com/installmonetizer/SelectAndCalculate.php" "$PLUGINSDIR\Installmanager.exe" /end
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 ; Delete $SYSDIR\SelectAndCalculateShellExt.dll 
  File "CryptoObfuscator_Output\${MUI_FILE}.exe"
 ; File "readme.txt"
  ;File "..\..\..\helpfile\Select and Calculate - User's Manual.chm";
  File "Select and Calculate - User's Manual.url";
...
File "Microsoft.Win32.Primitives.dll"
 ...
 ; File "MouseKeyboardLibrary.dll"
  ...
  ExecWait "NDP461-KB3102438-Web.exe /q"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Select and Calculate" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Select and Calculate" "InstallationDirectory" $INSTDIR
...
;  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\SelectAndCalculateShellExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Select and Calculate"
  DeleteRegKey HKCU "Software\4dots Software\Select and Calculate"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/select-and-calculate/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/select-and-calculate/how-to-use.php?afterinstall=true"
FunctionEnd
